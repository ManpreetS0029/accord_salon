...
@section('content')
    ...
    <div class="panel-heading"><a href="<?php echo route('purchase.paymenthistory', $purchase->id ); ?>">< Back</a> Update Sale Payment </div>
			...
			<div class="row">
			    ...
			    <div class="col-lg-6" style="text-align: right;">
					<p style="font-size: 16px;">Amount Paid: <?php echo number_format($purchase->getTotalPaidAmount(), 2); ?><br /> 
					    ...
					    ?>
                            Amount Under Review: <?php echo $purchase->getAmountUnderReview(); ?>
					    <?php 
					    }
					    ?>
					</p>
                    ...
                    {{ Form::open(array( 'method' => 'post', 'route' => ['purchase.updatepayment' , $purchase->id, $payment->id] )) }}
                            {{ csrf_field() }}
