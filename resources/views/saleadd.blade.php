                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body container-fluid">
                                ...
                                <!--<div class="row">
                                    <div class="col-md-6">
                                        <label >
                                            <input class="checkbox-inline" style="vertical-align: 1px;" type="checkbox" value="1" name="ispackage" id=""> Custom Package
                                        </label>
                                    </div>
                                </div>
                                <br /> -->
                                        ...
                                        <table class="sales_table table table-hover table-bordered">
                                                ...
                                                <th colspan="10">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3" id="advance_box" style="color: #ff0000;">
                                            ...
                                            <tr>
                                                <th colspan="10">
                                                    ...
                                                    <div id="sale_other_payment_info2" class="form-group " style="<?php if(Request::old('paymentmodeid') != '5' ) {  echo 'display:none'; } ?>">
                                                        <div class="row">
                                                            <div class="form-group col-md-3">
                                                                {{ Form::label('otherpaymentmethod', 'Other Payment Mode') }} *
                                                                {{ Form::text('other[]', '' , array('class' => 'form-control' ) ) }}
                                                    ...
                                                    <div id="sale_bank_payment_info2" class="form-group" style="<?php if(Request::old('paymentmodeid') != '2' ) {  echo 'display:none'; } ?>">
                                                        <div class="row">
                                                            <div class="form-group col-md-3">
                                                                {{ Form::label('bankname', 'Bank Name') }}
                                                                {{ Form::text('bankname[]', '' , array('class' => 'form-control' ) ) }}
...
var servicesTaxPercent = <?php echo SERVICE_TAX; ?>;
        ...
        rowsString += '<td>{product_servicename}<br /><select class="form-control" name="statuses[]"><option value="Pending">Pending</option><option value="Under Process">Under Process</option><option value="Completed">Completed</option></select></td>';
