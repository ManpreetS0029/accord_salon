            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel">
                            {{ Form::open(array( 'method' => 'PUT', 'route' => array( 'package.update', $package->id ))) }}
                            {{ csrf_field() }}
                                ...
                                <div class="row row-lg">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('title', $package->title, array('class' => 'form-control') ) }}
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                {{ Form::label('price', 'Price') }} *
                                                {{ Form::text('price', $package->price, array('class' => 'form-control') ) }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            {{ Form::label('description', 'Description') }}
                                            {{ Form::textarea('description', $package->description, array('class' => 'form-control') ) }}
                                        </div>
