		...
		for (var x = 0; x < jsonObjForServices.length; x++) {
			...
			if( jsonObjForServices[x]['types'] == 'package' )
			{
				...
				for( var k = 0; k < jsonObjForServices[x]['services'].length ; k++ )
				{
				    ...
				    strStaff += '<div class="service_staff_box" data-name="staffs_'+jsonObjForServices[x]["id"]+'_'+jsonObjForServices[x]['services'][k]["id"]+'">'+jsonObjForServices[x]['services'][k]['name']+'<br /><button type="button" class="addstaff">Add Staff</button></div>';
				}
			    }
			}
			else if( jsonObjForServices[x]['types'] == 'service' )
			{
			    strStaff += '<div class="service_staff_box" data-name="staffs_services_'+jsonObjForServices[x]["id"]+'"><button type="button" class="addstaff">Add Staff</button></div>';
			}
...
//	var staffStr = '<div><select name="staffs_product_'+item['id']+'">'+staffOptions+'</select></div>';
					    ...
					    var staffStr = '<div class="service_staff_box" data-name="staffs_product_'+item['id']+'"><button type="button" class="addstaff">Add Staff</button></div>';
