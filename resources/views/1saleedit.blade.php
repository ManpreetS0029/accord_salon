                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="row">
                                                ...
                                                {{ Form::select('clientid', $clients, $sale->client ? $sale->client->id : '0' , array('class' => 'form-control') ) }}
                                        </div>

                                                <div class="col-md-6">
                                                    {{ Form::text('walkin_name', $sale->walkin_name ?  $sale->walkin_name : 'Walk-In' , array('class' => 'form-control') ) }}
                                                </div>
                                ...
                                <div class="row" style="border: 1px solid #ccc;">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class=""><a data-toggle="tab" href="#tab_products">Products</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div id="tab_package" class="tab-pane fade in active">
                                                ...
                                                echo '<button data-type="package" type="button" id="'.$R->id.'" class="addbtnssale btn btn-primary"> + '. $R->title." (".$R->price.")".'</button>';
                                                    ...
                                                    $servicesArr[] = array( "id" => $R->id, "name" => $R->title, "price" =>  $R->price, 'types' => 'package' );
                                                    $servicesJsonData .= '{ "id" : "'.$R->id.'", "name" : "'.addslashes($R->title).'", "price" : "'.$R->price.'", "types" : "package" '.$servicesInside.' },';
} ?>
                                            </div>
...
<br /><br />
                                        ...
                                        <div class="tab-content">
                                            ...
                                            foreach( $cat->services as $R )
                                            {
                                                ...
                                                $servicesArr[] = array( "id" => $R->id, "name" => $R->name, "price" =>  $R->price, 'types' => 'service' );
                                                $servicesJsonData .= '{ "id" : "'.$R->id.'", "name" : "'.addslashes($R->name).'", "price" : "'.$R->price.'", "types" : "service" },';
                                            }
...
?>
						...
						{
						$selected = '';
						if( $staff->id == $packageItem->staffid )
						{
                                                $selected = ' selected ';
						}
						...
						$rowsString .= '<td><span class="class_unitprice">'.$item->actualpriceperitem.'</span></td>';
							...
							<option  <?php echo $sale->discounttype == 'absolute' ? 'selected' : ''; ?> value="absolute">Absolute</option>
                                            ...
                                            <tr>
                                                ...
                                                <th align="left" colspan="3">
                                                    ...
                                                    <span id="taxable_amount"><?php echo $subTotal - $sale->discountamount;  ?></span>
                                                </th>
                                            </tr>
                                            <tr>
...
<script>
    ...
    var rowsString = '<tr>';
    rowsString += '<td>{rowno}<input type="hidden" data-type="{itemtype}" class="sale_ids" name="ids[]" value="{ids}" /><input type="hidden" class="sale_itemtype" name="itemtypes[]" value="{itemtype}" /></td>';
    rowsString += '<td>{product_servicename}</td>';
    rowsString += '<td><span class="class_unitprice">{unitprice}</span></td>';
